...
function EmailVerificationScreen(): React.JSX.Element {
  const navigation = useNavigation<EmailVerificationScreenNavigationProp>();
  const route = useRoute();
  const { email, fromSignUp = false } = (route.params as RouteParams) || {};
  const { sendEmailVerification, verifyEmailCode, loading } = useAuth();
        ...
        <View style={styles.mainContent}>
          ...
          <View style={styles.emailIconContainer}>
            <LinearGradient
              ...
              style={styles.emailIconGradient}
            >
              <Icon name="mail" size={48} color="#4ECDC4" />
            </LinearGradient>
          </View>
